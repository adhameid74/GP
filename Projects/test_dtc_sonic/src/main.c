...
void main (void) {
	...
	while(1){
		USONIC_f32GetDistance(USONIC2,&dhjk);
		USONIC_f32GetDistance(USONIC1,&dhjk);
		i++;
		if (i==50) {
			i=0;
			/*
			aghjj=HEEPROM_u8ReadByte(0xa0,0);
			aghjj=HEEPROM_u8ReadByte(0xa0,1);
			aghjj=HEEPROM_u8ReadByte(0xa0,2);
			aghjj=HEEPROM_u8ReadByte(0xa0,3);
			aghjj=HEEPROM_u8ReadByte(0xa0,4);
			aghjj=HEEPROM_u8ReadByte(0xa0,5);
			aghjj=HEEPROM_u8ReadByte(0xa0,6);
			aghjj=HEEPROM_u8ReadByte(0xa0,7);
			aghjj=HEEPROM_u8ReadByte(0xa0,8);
			aghjj=HEEPROM_u8ReadByte(0xa0,9);
			aghjj=HEEPROM_u8ReadByte(0xa0,10);
*/
			aghjj=0;
		}
	}
