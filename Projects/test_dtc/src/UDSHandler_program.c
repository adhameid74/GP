...
void UDSHandler_voidSendNegResponse(u8 Copy_u8SID, u8 Copy_u8NRC)
{
	...
	NegativeResponse.MessageData[0] = Local_au8Data[0];
	NegativeResponse.MessageData[1] = Local_au8Data[1];
	NegativeResponse.MessageData[2] = Local_au8Data[2];
...
void UDSHandler_voidSendPosResponse(u8* Copy_pu8Message, u8 Copy_u8Length)
{
	...
	{
		PositiveResponse.MessageData[i] = Copy_pu8Message[i];
	}
